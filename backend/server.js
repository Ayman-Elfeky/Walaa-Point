...
app.use(cors({
    origin: function (origin, callback) {
        ...
        const allowedOrigins = ['http://localhost:3000', 'http://localhost:5173', 'http://localhost:4173', "https://app7000.maayn.me", "http://localhost:7000", "http://srv852192.hstgr.cloud"];
